...
def print_cox_results(scheme='n+n', numPilotSample=100, isEqualTime=False):
    ...
    print('Time unif: ' + str(round(np.sum(times))))      
    ...
    print('Time optimal: ' + str(round(np.sum(times))))   
    ...
    print('Time full: ' + str(round(np.sum(times))))       
...
# Misspecified model
'''
model_type = ['Cox', 'AH', 'TM']
'''
print_cox_results(scheme = 'n+n')
